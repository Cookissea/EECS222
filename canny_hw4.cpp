...
int main(int argc, char *argv[])
{
   ...
   unsigned char image[320*240];     /* The input image */
   unsigned char edge[320*240];      /* The output edge image */
         ...
         float tlow, float thigh, unsigned char *edge, char *fname)
{
   ...
   unsigned char nms[320*240];        /* Points that are local maximal magnitude. */
   short int smoothedim[320*240],     /* The image after gaussian smoothing.      */
             delta_x[320*240],        /* The first devivative image, xfdirection. */
             delta_y[320*240],        /* The first derivative image, y-direction. */
             magnitude[320*240];      /* The magnitude of the gadient image.      */
   //int r, c, pos;
   //float dir_radians[320*240];   /* Gradient direction image.                */
        ...
        short int *smoothedim)
{
   ...
   float tempim[320*240],        /* Buffer for separable filter gaussian smoothing. */
